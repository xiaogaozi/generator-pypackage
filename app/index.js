...
PypackageGenerator.prototype.askForClassifier = function askFor() {
  var cb = this.async();
  var prompts = [{
    type: 'confirm',
    name: 'setClassifier',
    message: 'Set classifier?',
    default: true
  }, {
    type: 'checkbox',
    name: 'classifierDevelopmentStatus',
    message: 'Choose Development Status',
    choices: [
    ...
    when: function (props) {
      return props.setClassifier;
    }
  }, {
    type: 'checkbox',
    name: 'classifierEnvironment',
    ...
    type: 'checkbox',
    name: 'classifierIntendedAudience',
    message: 'Choose Intended Audience',
    choices: [
    ...
    type: 'checkbox',
    name: 'classifierNaturalLanguage',
    message: 'Choose Natural Language',
    choices: [
    ...
    type: 'checkbox',
    name: 'classifierOperatingSystem',
    ...
    type: 'checkbox',
    name: 'classifierProgrammingLanguage',
  ...
  this.prompt(prompts, function (props) {
    this.setClassifier = props.setClassifier;
    this.classifierDevelopmentStatus = props.classifierDevelopmentStatus;
    this.classifierEnvironment = props.classifierEnvironment;
    this.classifierFramework = props.classifierFramework;
    this.classifierIntendedAudience = props.classifierIntendedAudience;
    this.classifierLicense = props.classifierLicense;
    this.classifierNaturalLanguage = props.classifierNaturalLanguage;
    this.classifierOperatingSystem = props.classifierOperatingSystem;
    this.classifierProgrammingLanguage = props.classifierProgrammingLanguage;
    this.classifierTopic = props.classifierTopic;
    cb();
  }.bind(this));
};
